...
async def list_shipments(
    ...
    """
    shipments = shipment_repo.list_all_shipments(
        limit=limit, offset=offset, status=status, q=q, customer_id=customer_id
    )
    total = shipment_repo.count_shipments(status=status, q=q, customer_id=customer_id)
